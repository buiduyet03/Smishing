...
import kma.hvktmm.smishguard.views.RecyclerViewFragment;
...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String ABOUT_TEXT = "<html><h4>About</h4>This is a Proof-of-Concept application from Red Maple Technologies." +
            "<br><br>" +
            "<h4>How it Works</h4>SmishGuard retrieves all messages currently in the inbox, and inspects them for URLs (links)." +
    ...
    private void launchAboutDialog() {
        ...
        try {
            PackageInfo pInfo = SmishGuard.getAppContext().getPackageManager().getPackageInfo(SmishGuard.getAppContext().getPackageName(), 0);

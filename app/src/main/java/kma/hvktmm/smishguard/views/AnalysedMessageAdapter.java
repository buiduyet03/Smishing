...
import kma.hvktmm.smishguard.analysis.OrganisationInfo;
...
public class AnalysedMessageAdapter extends RecyclerView.Adapter<AnalysedMessageAdapter.ViewHolder> {
    ...
    public void addAll(AnalysedMessage[] dataSet) {
        // get comparison data
        orgsInfo = OrganisationInfo.getInfoFromJSON(SmishGuard.getAppContext());
    ...
    public void onBindViewHolder(ViewHolder viewHolder, final int position) {
        ...
        if (!messageData[position].isAnalysed()) {
            ...
            messageData[position].analyse(SmishGuard.getAppContext(), orgsInfo);
        }

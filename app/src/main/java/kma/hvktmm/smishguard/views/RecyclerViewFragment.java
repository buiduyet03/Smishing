package kma.hvktmm.smishguard.views;
...
import kma.hvktmm.smishguard.SmishGuard;
import kma.hvktmm.smishguard.analysis.AnalysedMessage;
import kma.hvktmm.smishguard.analysis.Messages;
import kma.hvktmm.smishguard.sms.Forward;
...
public class RecyclerViewFragment extends Fragment{
    ...
    private void reportMessage(int position) {
        ...
        builder.setMessage("Report this message as spam?").setIcon(android.R.drawable.ic_dialog_alert)
                .setPositiveButton(android.R.string.yes, (dialog, whichButton) -> {
                    ...
                    Context context = kma.hvktmm.smishguard.SmishGuard.getAppContext();
    ...
    public void refreshView() {
        ...
        Context context = SmishGuard.getAppContext();
